...
# Main function to handle the session and dynamically update cookies
def maintest():
    ...
    # Example MCX URL (change this as needed)
    mcx_url = "https://www.mcxindia.com/BackPage.aspx/GetTicker"

    # Send a request to get the cookies and maintain the session
    initial_response = session.get(mcx_url)
